...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕GROUP⭕', url='https://t.me/joinchat/-3Vjw61udNM3OWU9'),
            InlineKeyboardButton('🔰OTT MOVIES🔰', url='https://t.me/+S384rYHJgf1mYmQ1')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="♻CHANNEL♻",url="https://t.me/joinchat/VtTZc5al3Vt0te9_")]
        )
    else:
        btn.append(
